...
{
	FVector RealizedKnockbakImpulse = FVector(KnockbackImpulse.X, KnockbackImpulse.Y, 100.f);
	
	this->LaunchCharacter(RealizedKnockbakImpulse, true, true);
}
...
void AAuraCharacterBase::StunTagChanged(FGameplayTag CallbackTag, int32 NewCount)
{
